...
def parse_args():
    ...
    parser.add_argument('--vina_program')
    ...
    parser.add_argument('--db_device', type=int)
    parser.add_argument('--db_env', type=str)
    parser.add_argument('--db_relax_env', type=str)
    parser.add_argument('--db_script', type=str)
    parser.add_argument('--db_batch_size', type=int, default=32)
    parser.add_argument('--db_inference_steps', type=int, default=20)
    parser.add_argument('--db_protein_pdb_1', type=str)
    parser.add_argument('--db_protein_pdb_2', type=str)
...
def update_args(args):
    ...
    args.db_config_1 = get_db_config_1(args)
    args.db_config_2 = get_db_config_2(args)
...
def get_db_config_1(args):
    db_config_1 = {
        ...
        'protein_pdb': args.db_protein_pdb_1,
...
def get_db_config_2(args):
    db_config_2 = {
        ...
        'python': args.db_env,
        'relax_python': args.db_relax_env,
        'protein_pdb': args.db_protein_pdb_2,
        'results': args.db_results,
        'header': args.db_header,
        'paper': args.paper,
        'seed': args.seed,
