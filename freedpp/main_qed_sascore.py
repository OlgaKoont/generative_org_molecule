...
from freedpp.env.reward import Reward, MolLogP, PatternFilter, OutOfRange, identity, BRSASCORE, check_sascore
...
def init_rewards(args):
    ...
    costs = {
        ...
        'SA_Score': Reward(check_sascore, OutOfRange(lower=1, upper=6, hard=hard), preprocess=preprocess)
    }
    rewards = dict()
