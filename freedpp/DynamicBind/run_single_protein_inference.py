...
if args.hts:
    ...
    do(cmd)
    cmd = f"MKL_SERVICE_FORCE_INTEL=1 MKL_THREADING_LAYER=GNU CUDA_VISIBLE_DEVICES={args.device} {python} {script_folder}/screening_old.py --seed {args.seed} --ckpt {ckpt} {protein_dynamic}"
