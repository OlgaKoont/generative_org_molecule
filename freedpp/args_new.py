...
def parse_args():
    ...
    # Docking
    parser.add_argument('--receptor_1', required=True)
    parser.add_argument('--box_center_1', required=True, type=str2floats)
    parser.add_argument('--box_size_1', required=True, type=str2floats)
...
def get_docking(args):
    ...
    dock_1 = DockingVina(docking_config_1)
    dock_2 = DockingVina(docking_config_2)
    difference = (dock_1 - dock_2)
